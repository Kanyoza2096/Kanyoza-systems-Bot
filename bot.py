...
CONTENT_FORMATS = {
    "lessons_learned": """
Start with: '{hook}'
Tell a real 3-4 sentence story.
Give 3-5 numbered lessons (specific, actionable).
End with one memorable takeaway + question.
Tone: Colleague over coffee. 400-600 words.
""",
    "controversial_take": """
Start with: '{hook}'
State opinion clearly (2-3 sentences).
Give 2-3 specific examples.
Acknowledge when conventional wisdom IS right.
End with: "What's a tech opinion you disagree with?"
Confident but not arrogant. Use "in my experience."
""",
    "quick_win": """
Start with: '{hook}'
Problem (1 sentence).
Solution (include code if relevant).
Why it works (brief).
Where to learn more.
200-300 words. Useable TODAY.
""",
    "behind_the_scenes": """
Start with: '{hook}'
What people think software engineering is.
What it actually is (specific example from your week).
Why this reality matters.
Make people feel seen.
""",
    "story_lesson": """
Start with: '{hook}'
Setup → Complication → Turning Point → Resolution.
Universal lesson beyond tech.
500-700 words. Make them feel there.
"""
}
